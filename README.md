...
- <img src="https://www.npmjs.com/favicon.ico" height="14"/> [synapse-code-mcp](https://github.com/Eltortilla1/synapse-code-mcp) - Structural code context server for AI agents — compressed symbol indexes, dependency graphs, and git diffs via TypeScript AST analysis. Zero external dependencies, no vector database or embedding API required.
<br />
